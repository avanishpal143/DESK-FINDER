      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 relative">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="fade-up">
            {/* Tagline badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#0B0B0B] text-white text-xs mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-[#C9A23B]" />
              Where work finds space
            </div>

            <h1 className="font-bold text-[52px] sm:text-[68px] lg:text-[80px] leading-[0.92] tracking-[-0.045em]">
              One pass.<br />
              <span className="squiggle">Every desk.</span><br />
              Done.
            </h1>

            <p className="max-w-[460px] mt-5 text-[15px] text-[#0B0B0B]/60 leading-[1.65]">
